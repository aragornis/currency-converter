...
class RatesTests(unittest.TestCase):
    def setUp(self):
        ...
        self.__knownRates = [('EUR', 2.0), ('USD', 1.6), ('RUB', 1.9), ('TRY', 0.7)]
    ...
    def test_setExistingRate(self):
        self.assertEqual(self.__repository.getRatesCount(), 4)
        self.assertEqual(self.__repository.getRate('EUR'), 2.0)
        self.__repository.setRate('EUR', 0.1)
        self.assertEqual(self.__repository.getRatesCount(), 4)
        self.assertEqual(self.__repository.getRate('EUR'), 0.1)
